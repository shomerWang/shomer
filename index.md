...
<div class="container">
  <div class="header"><img src="//shomerWang/shomerpage/logo.jpg" width="145" height="145" id="Insert_logo" style="background-color: #B3DDFF; display:block;" />
    <!-- end .header --></div>
  <div class="content">
    <h1>王祖修的網頁</h1>
    ...
    <!-- end .content --></div>
  <div class="footer">
    <p><a herf="shomerwang@gmail.com">聯絡我</a></p>
    <!-- end .footer --></div>
  <!-- end .container --></div>
</body>
</html>
